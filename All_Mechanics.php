<html>
    <head>
        <title>All Mechanics | Fleet Management System</title>
        <meta charset="utf-8">
  ...
  <div class="container">
    ...
    ?>
        ...
        <footer style="padding: 20px; margin-top: 175px; color: #ffffff; background-color: #053D4F; text-align: center; border-top: #e8491d 3px solid;position: fixed; left:0;bottom: 0;width: 100%;text-align: center;">
